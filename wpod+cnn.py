...
Original file is located at
    https://colab.research.google.com/drive/1JAkZMv64dmEd6-ibo7WzcFdxoVzShdzN
"""

# get_ipython().system_raw("unrar x Plate_detect_and_recognize-master.zip")

# !unzip "/content/Plate_detect_and_recognize-master.zip" -d "/content/Plate_detect_and_recognize-master"

# !unzip "/content/GreenParking.zip" -d "/content/new_Dataset_VN"

# !unzip "/content/dataset_bike-20221118T074512Z-001.zip" -d "/content/new_Dataset_VN"
...
def IOU(tl1, br1, tl2, br2):
    ...
    print("br1: %s, tl1: %s,br2: %s,tl2: %s"%(br1,tl1,br2,tl2))
    ...
    for label in Labels:
        ...
        for sel_label in SelectedLabels:
            if IOU_labels(label, sel_label) > iou_threshold:
                print("IoU:",IOU_labels(label, sel_label) )
                non_overlap = False
                break
...
wpod_net_path = "/content/Plate_detect_and_recognize-master/Plate_detect_and_recognize-master/wpod-net.json"
...
# define standard width and height of character
  ...
  for c in sort_contours(cont):
      ...
      if 0.1 < aspectRatio < 1.0 and solidity > 0.1 and 0.35 < heightRatio < 2.0: 
              ...
              _, curr_num = cv2.threshold(curr, 99, 255, cv2.THRESH_BINARY + cv2.THRESH_OTSU)
...
#             # Sperate number and gibe prediction
#             curr = thre_mor[y:y+h,x:x+w]
#             curr = cv2.resize(curr, (30,60),cv2.INTER_AREA)
#             _, curr_num = cv2.threshold(curr, 90, 255, cv2.THRESH_BINARY + cv2.THRESH_OTSU)
#             crop_characters.append(curr_num)
#             cv2_imshow(curr_num)
# #Arrange unsorted characters when it detected:
# def sortCharacters(crop_characters):
#   crop=[]
#   if heightRatio<0.6:
#     for i in range(1,len(crop_characters),2):
#       crop.append(crop_characters[i])
...
json_file = open('/content/Plate_detect_and_recognize-master/Plate_detect_and_recognize-master/MobileNets_character_recognition.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
model = model_from_json(loaded_model_json)
model.load_weights("/content/Plate_detect_and_recognize-master/Plate_detect_and_recognize-master/License_character_recognition_weight.h5")
print("[INFO] Model loaded successfully...")

labels = LabelEncoder()
labels.classes_ = np.load('/content/Plate_detect_and_recognize-master/Plate_detect_and_recognize-master/license_character_classes.npy')
...
def sum_predict():
  test_image_path = "/content/Plate_detect_and_recognize-master/Plate_detect_and_recognize-master/Plate_examples/vietnam_motor_plate.jpg"

  vehicle, LpImg,cor = get_plate(test_image_path,608,288)
  ...
  plate_cor, crop_characters, heightRatio, h_avg =Ocr_segment(cont,plate_image,binary, thre_mor)
  # print(data)
  ...
  # plt.imshow(test_roi)
  # plt.savefig('grab_digit_contour.png',dpi=300)
  out_put(crop_characters,plate_cor,h_avg)
sum_predict()